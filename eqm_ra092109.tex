...
synchronization-based impelementation  of  Treplica \cite{vieira2008}   into  a
 functionally equivalent  wait-free   Treplica.   The  performance of the two will be compared using micro benchmarks to assess the contribution  of
